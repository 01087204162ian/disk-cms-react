...
### 📚 메인 문서
- **[약국배상책임보험 시스템 통합 문서](./pharmacy-통합-문서.md)** ⭐ - 전체 시스템 가이드

### 📝 작업 내역 (`work-logs/`)
- [2025-01 작업 내역](./work-logs/2025-01-작업내역.md) - 증권 확인 기능 개선 및 자동 재생성 기능 추가
- [2025-01 hi/v2 작업 내역](./work-logs/2025-01-hi-v2-작업내역.md) - 구내치료비 보상한도 동적 표시 기능 추가
- [2025-01 약국배상 테이블 UI 개선](./work-logs/2025-01-약국배상-테이블-UI-개선.md) - 테이블 UI/UX 개선 작업
- [2026-01-02 약국배상 상태변경 오류 해결](./work-logs/2026-01-02-약국배상-상태변경-오류-해결.md) - 상태 변경 오류 해결 작업
- [작업 로그](./work-logs/WORK_LOG.md) - 전체 작업 로그

### 🔍 시스템 분석 (`analysis/`)
- [고객사 어드민 시스템 v2 분석](./analysis/hi-v2-시스템-분석.md) - `imet/hi/v2/` 폴더 분석
- [학습 요약](./analysis/LEARNING_SUMMARY.md) - 시스템 학습 내용 요약

### 🛠️ 문제 해결 가이드 (`guides/`)
- [pharmacy-status-update.php 오류 해결 가이드](./guides/pharmacy-status-update-fix-guide.md) - 상태 변경 오류 해결 방법
- [보험료 표기 문제 확인 가이드](./guides/보험료-표기-문제-확인-가이드.md) - 화재보험료 표기 문제 해결 과정
