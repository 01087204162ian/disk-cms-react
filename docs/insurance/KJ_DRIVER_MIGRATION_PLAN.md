...
- [ ] 공통 유틸리티 함수
- [ ] work-log.md 업데이트 (공통 컴포넌트 완료 시)

#### 3-2. 코드 리팩토링
- [ ] 중복 코드 제거
- [ ] 컴포넌트 재사용성 향상
- [ ] 타입 정의 정리
- [ ] work-log.md 업데이트 (리팩토링 완료 시)
...
#### 4-4. work-log.md 최종 업데이트
- [ ] Phase 4 완료 시 work-log.md 최종 정리
...
### 업데이트 시점
- **각 작업 종류(페이지/컴포넌트) 완료 시**: work-log.md 정리
- **단계별 완료 시**: work-log.md 정리
- **중간 정리 필요 시**: "work-log.md 정리하세요" 지시 시 즉시 정리
