      ...
      {modalOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-xl bg-background border border-border p-6">
            <div className="text-lg font-semibold">승인/거부 처리</div>
            ...
            <div className="mt-4">
              <div className="text-sm font-medium mb-1">거부 사유(거부 시 필수)</div>
              <textarea
              ...
              />
              {modalError ? <div className="mt-2 text-sm text-destructive">{modalError}</div> : null}
            </div>
            ...
            <div className="mt-6 flex gap-2 justify-end">
              ...
              <button
                onClick={approve}
                className="px-4 py-2 rounded-lg bg-primary text-primary-foreground hover:opacity-90 text-sm inline-flex items-center gap-2"
              >
